...
-- 스케치북 작성 O
	...
	-- 스케치북 수정
		-- 스케치북 정보 수정 O (사용자-마이페이지) --!!!! 스케치북 DELFLAG 가  비공개면 정보 수정가능?!!!!!
	...
	-- 스케치북 조회
	   ...
	   SELECT SKETCH_ID, SKETCH_TITLE, SKETCH_CONTENT, SKETCH_SPATH
		  FROM (SELECT ROWNUM RNUM, SKETCH_ID, SKETCH_TITLE, SKETCH_CONTENT, SKETCH_SPATH
			 FROM (SELECT SKETCH_ID, SKETCH_TITLE, SKETCH_CONTENT, SKETCH_SPATH
					FROM LPSKETCHBOOK
		...
		-- 스크랩한 스케치북 조회
		SELECT LPSKETCHBOOK.SKETCH_ID, SKETCH_THEME, SKETCH_TITLE, SKETCH_SHARE, SKETCH_CONTENT, SKETCH_SPATH FROM LPSKETCHBOOK, LPCOLLECT WHERE LPCOLLECT.USER_EMAIL='128@happy.com' AND LPSKETCHBOOK.SKETCH_ID = LPCOLLECT.SKETCH_ID AND LPSKETCHBOOK.SKETCH_SHARE='T' AND LPSKETCHBOOK.SKETCH_DELFLAG='F' AND LPSKETCHBOOK.SKETCH_BLOCK='F';
