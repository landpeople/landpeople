										...
										<tbody>
											...
											<tr>
												<td align="center" style="word-break: break-word; font-size: 0px; padding: 10px 25px; padding-top: 20px;"><table align="center" cellpadding="0" cellspacing="0" style="border-collapse: separate;" border="0">
														<tbody>
															<tr>
																<td align="center" valign="middle" style="border: none; border-radius: 3px; color: white; cursor: auto; padding: 15px 19px;" bgcolor="#7289DA"><a href="이메일인증주소적는곳" style="text-decoration: none; line-: 100%; background: #7289da; color: white; font-family: ubuntu, helvetica, arial, sans-serif; font-size: 15px; font-weight: normal; text-transform: none; margin: 0px;" target="_blank" rel="noreferrer noopener">  비밀번호 수정 </a></td>
															</tr>
														</tbody>
													</table></td>
											</tr>
