	...
	<div class="main-wrapper">
		...
		<div class="sidebar-menu">
			<div class="top-section">
				...
				<div class="profile-image" onclick="location.href='./index.jsp'"></div>
			</div>
		...
		<div class="content-wrapper">
			...
			<div class="main-lpcontents">
				<div class="content">
					...
					<a href="./test.do">테스트 페이지로 이동</a><br>
					<a href="./kim.do">김태우	페이지로 이동</a><br>
					<a href="./na.do">나원서 페이지로 이동</a><br>
					<a href="./lee.do">이연지 페이지로 이동</a><br>
					<a href="./jang.do">장석영 페이지로 이동</a><br>
					<a href="./jeong.do">정희태 페이지로 이동</a><br>
