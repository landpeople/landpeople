					...
					success : function(map) {
						...
						if (map.user_iswrite == "F" || map.user_iswrite == null)
							...
							var htmlModal = "<input type='hidden' name='user_email' value='"+map.user_email+"'>"
									...
									+ "<input type='radio' id='familytheme' name='sketch_theme' value='With me'><label for='familytheme'>With me</label>"
									+ "<input type='radio' id='solotheme' name='sketch_theme' value='With family'><label for='solotheme'>With family</label>"
									+ "<input type='radio' id='coupletheme' name='sketch_theme' value='With love'><label for='coupletheme'>With love</label>"
									+ "<input type='radio' id='friendtheme' name='sketch_theme' value='With friend'><label for='friendtheme'>With friend</label>"
									+ "</div>"
									+ "</div>"
									+
