...
alert("총 스케치북 갯수 : " + ${fn:length(mySketchBookLists)});
</script>
   <!-- Page Wrapper -->
   <div id="wrapper">
         ...
         <div id="content" style="display: flex; flex-direction: column;">
            ...
            <div class="lp-container">
               <div class="lp-content shadow-lg">
                  ...
                  <h1 class="h3 mb-3 text-gray-800">My Sketchbook</h1>
                  <form action="#" method="post" id="sketchDel" name="sketchDel" onsubmit="return DelchkBox()" style="width:100%; height:100%;">
                     <div class="sketchBookContent">
                        <c:forEach var="item" items="${mySketchBookLists}" varStatus="i">
                           <c:choose>
                               ...
                               <!--스케치북 1개 담는 div  -->
                                <div class="sketchBookContainer">
                                 ...
                                 <div style="width: 100%; height: 60px; border: 1px solid black; position: absolute; bottom: 0px;">
                                    ...
                                    <label>${item.sketch_title}</label><label style="float: right;">${item.sketch_id}</label><br> <label><a href="#" onclick="return sketchBookModify('${item.sketch_id}')">
...
//                               if (mySketchBookLists.get(i).getSketch_block().trim().compareToIgnoreCase("T") == 0) {
<%--                            %> --%>
<!--                            스케치북 1개 담는 div  -->
<!--                            <div class="sketchBookContainer"> -->
<%--                               <div class="selectTheme" style="background-image: url('<%=mySketchBookLists.get(i).getSketch_spath()%>');"> --%>
<!--                                  <div class="sketchTheme_hover" style="cursor: pointer;"> -->
<!--                                     <div class="hover_inside"> -->
<!--                                        <h5>관리자에 의해 삭제되었습니다.</h5> -->
<!--                                     </div> -->
...
<!--                               </div> -->
<!--                               <div style="width: 100%; height: 60px; border: 1px solid black; position: absolute; bottom: 0px;"> -->
<%--                                  <input type="checkbox" name="chkVal" value="<%=mySketchBookLists.get(i).getSketch_id()%>"> --%>
<%--                                  <label><%=mySketchBookLists.get(i).getSketch_title()%></label><label style="float: right;"><%=mySketchNickname.get(sketch_id)%></label><br> <label><a href="#" onclick="return sketchBookModify('<%=mySketchBookLists.get(i).getSketch_id()%>')"> --%>
<!--                                        <img alt="modi" src="img/sketch/modifyIcon.png">스케치북 수정 -->
<!--                                     </a></label> -->
<!--                               </div> -->
<!--                            </div > -->
...
<!--                            <div class="sketchBookContainer"> -->
<%--                               <div class="selectTheme" style="background-image: url('<%=mySketchBookLists.get(i).getSketch_spath()%>');"> --%>
<%--                                  <div class="sketchTheme_hover" style="cursor: pointer;" onclick="location.href='./detailCanvas.do?sketch_id=<%=mySketchBookLists.get(i).getSketch_id()%>'"> --%>
<!--                                     <div class="hover_inside"> -->
<!--                                        <h5> -->
<!--                                           <img alt="likeIcon" src="./img/sketch/likeIcon.png"> -->
<%--                                           <%=sketchLike.get(sketch_id)%> --%>
<%--                                           <%=mySketchBookLists.get(i).getSketch_theme()%> --%>
<!--                                        </h5> -->
<!--                                     </div> -->
<!--                                  </div> -->
<!--                               </div> -->
