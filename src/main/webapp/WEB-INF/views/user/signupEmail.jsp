               ...
               <div class="card-body p-0">
                  <div class="p-5">
                     <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-2">이메일 전송이 성공하였습니다!</h1>
                        <p class="mb-4 form-text">이메일 인증후 로그인이 가능합니다 .<br>이메일 인증을 해주세요</p>
                     </div>
                     <form class="user" action="./loginPage.do" method="get">
